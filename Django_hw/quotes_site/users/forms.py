from django.forms import ModelForm, CharField, TextInput, EmailField, EmailInput, PasswordInput, Form
...
class MyPasswordResetForm(PasswordResetForm):
    email = EmailField(label="Email", max_length=100, widget=EmailInput(attrs={"class": "form-control"}))
